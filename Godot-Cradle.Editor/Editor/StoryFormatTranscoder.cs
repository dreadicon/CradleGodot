...
{
	[Tool]
	public partial class StoryFormatTranscoder : EditorPlugin
	{
		public StoryImporter Importer { get; internal set; }

		public virtual StoryFormatMetadata GetMetadata() { return new StoryFormatMetadata(); }
		public virtual void Init() { }
		public virtual PassageCode PassageToCode(PassageData passage) { return new PassageCode(); }
